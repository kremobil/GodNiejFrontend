...
<template>
  <nav id="navbar">
    <div class="nav-popup" :class="{
      ...
      <ul>
        <li>
          <router-link to="/">Nasze Inicjatywy</router-link>
        </li>
        <li>
      ...
      <button id="mobile_support_us_button">
        <p>Wesprzyj fundację</p>
        <img src="@/assets/support_us.gif" alt="" width="48" height="48" />
      </button>
    </div>
    <div class="left">
      <router-link to="/">
        <img src="@/assets/a.png" alt="GodNiej Fundacja" id="logo">
      </router-link>
    ...
    <div class="right">
      <div class="socials">
        <a href="https://www.instagram.com/fundacja_godniej/" target="_blank">
        ...
        <a href="https://www.facebook.com/profile.php?id=61557730490821" target="_blank">
      ...
      <button id="support_us_button">
        <p id="button_label">Wesprzyj fundację</p>
        <img src="@/assets/support_us.gif" alt="" width="48" height="48" />
      </button>
    </div>
  </nav>
